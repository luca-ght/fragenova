...
export default function () {
    return (
        <div className="privacy_area">
            ...
            TTDSG); die Einwilligung ist jederzeit widerrufbar.</p> <p>Sie k&ouml;nnen Ihren Browser so einstellen, dass
            ...
            <h3>Local Storage</h3> <p>Unsere Webseite verwendet Local Storage-Technologien, um die Benutzererfahrung zu
            optimieren. Hierbei werden eingegebene Daten im Local Storage des Browsers gespeichert und lokal
            verarbeitet. Die Daten werden verschlüsselt an unsere Server übertragen und im Backend ausschließlich zur
            Verarbeitung genutzt. Es erfolgt keine automatische Löschung der im Local Storage gespeicherten Daten. Die
            gespeicherten Daten verbleiben im Local Storage, bis der Nutzer aktiv entscheidet, sie zu löschen. Wir
            respektieren Ihre Privatsphäre und gewährleisten, dass die gespeicherten Daten nur für den vorgesehenen
            Zweck verwendet werden.</p> <p></p>
            <h3>Cloudflare</h3> <p>Wir nutzen das Content Delivery Network (CDN) von Cloudflare Germany GmbH, Rosental
            ...
            ist, optimiert Inhalte an den Websitenutzer auszuliefern. Für diesen Zweck können personenbezogene Daten in
            Server-Logfiles von Cloudflare verarbeitet werden. Bitte vergleichen Sie die Ausführungen unter
            „Hosting“.</p><p>Cloudflare ist Empfänger Ihrer personenbezogenen Daten und als Auftragsverarbeiter für uns
            tätig. Die entspricht unserem berechtigten Interesse im Sinne des Art. 6 Abs. 1 S. 1 lit. f DSGVO, selbst
            kein Content Delivery Network zu betreiben. </p><p>Sie haben das Recht der Verarbeitung zu widersprechen. Ob
            ...
            vorgeschrieben. Die Funktionsfähigkeit der Website ist ohne die Verarbeitung nicht gewährleistet.</p><p>Ihre
            personenbezogenen Daten werden von Cloudflare so lange gespeichert, wie es für die beschriebenen Zwecke
            erforderlich ist.</p><p>Weitere Informationen zu Widerspruchs- und Beseitigungsmöglichkeiten gegenüber
            Cloudflare finden Sie unter: <a href="https://www.cloudflare.com/de-de/cloudflare-customer-dpa/"
                                            target="_blank">Cloudflare DPA</a></p><p>Cloudflare hat Compliance-Maßnahmen
            für internationale Datenübermittlungen umgesetzt. Diese gelten für alle weltweiten Aktivitäten, bei denen
            Cloudflare personenbezogene Daten von natürlichen Personen in der EU verarbeitet. Diese Maßnahmen basieren
            auf den EU-Standardvertragsklauseln (SCCs). Weitere Informationen finden Sie <a
                href="https://www.cloudflare.com/cloudflare_customer_SCCs-German.pdf" target="_blank">hier</a>. </p>
